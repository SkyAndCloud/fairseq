	    ...
	    --optimizer adam --adam-eps 1e-6 --clip-norm 5.0 \
	      --lr-scheduler chen --replicas-num 2 --warmup-steps 500 --start-step 8000 --end-step 64000 \
           ...
           --criterion label_smoothed_cross_entropy --label-smoothing 0.1 --weight-decay 0.0 \
		    --max-tokens 4096 --save-dir checkpoints/rnmt_base_nist_pe \
            --tensorboard-logdir events/rnmt_base_nist_pe \
            --max-epoch 30 \
		    --update-freq 1 --no-progress-bar --log-format json --log-interval 50 | tee logs/rnmt_base_nist_pe.log
